...
public class DandanUser extends AbstractObject {
    private Integer id;
    ...
    public DandanUser(String username) {
        this.username = username;
    }

    public DandanUser(String username, String password) {
        this.username = username;
    ...
    public void setTpwdsetting(String tpwdsetting) {
        this.tpwdsetting = tpwdsetting == null ? null : tpwdsetting.trim();
    }
    ...
    public void setInvit(String invit) {
        this.invit = invit == null ? null : invit.trim();
    }
    ...
    public Boolean getRegaward() {
        return regaward;
    }

    public void setRegaward(Boolean regaward) {
