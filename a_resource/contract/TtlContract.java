 ...
 */
public class TtlContract extends Contract {
    ...
    protected TtlContract(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected TtlContract(String contractAddress, Web3j web3j,
    ...
    public List<ReleaseSupplyEventResponse> getReleaseSupplyEvents(TransactionReceipt transactionReceipt) {
        ...
        for (EventValues eventValues : valueList) {
            ...
            typedResponse.receiver = (Address) eventValues.getNonIndexedValues().get(0);
    ...
    public List<UnfreezeAmountEventResponse> getUnfreezeAmountEvents(TransactionReceipt transactionReceipt) {
        ...
        for (EventValues eventValues : valueList) {
            ...
            typedResponse.unfreezeTime = (Uint256) eventValues.getNonIndexedValues().get(2);
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public List<TransferLockedTokenEventResponse> getTransferLockedTokenEvents(TransactionReceipt transactionReceipt) {
        ...
        for (EventValues eventValues : valueList) {
            ...
            typedResponse.releaseTime = (Uint256) eventValues.getNonIndexedValues().get(1);
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public RemoteCall<TransactionReceipt> transferLockedToken(Address _to, Uint256 _value,
            Uint256 _releaseTime) {
        Function function = new Function(
                "transferLockedToken", 
                Arrays.<Type>asList(_to, _value, _releaseTime), 
    ...
    public RemoteCall<TransactionReceipt> transferOperator(Address newOperator) {
        Function function = new Function(
                "transferOperator", 
    ...
    public RemoteCall<Uint256> lockedBalanceCount() {
    ...
    public RemoteCall<Tuple3<Address, Uint256, Uint256>> lockedBalances(Uint256 param0) {
        final Function function = new Function("lockedBalances", 
                Arrays.<Type>asList(param0), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
        return new RemoteCall<Tuple3<Address, Uint256, Uint256>>(
                new Callable<Tuple3<Address, Uint256, Uint256>>() {
                    @Override
                    public Tuple3<Address, Uint256, Uint256> call() throws Exception {
                        List<Type> results = executeCallMultipleValueReturn(function);;
                        return new Tuple3<Address, Uint256, Uint256>(
    ...
    public RemoteCall<Uint256> limitSupplyPerYear() {
    ...
    public RemoteCall<Address> operator() {
    ...
    public RemoteCall<Uint256> lockedBalanceOf(Address _owner) {
    ...
    public RemoteCall<Uint256> createTime() {
    ...
    public RemoteCall<Uint256> dailyLimit() {
    ...
    public RemoteCall<TransactionReceipt> setDailyLimit(Uint256 _dailyLimit) {
        Function function = new Function(
                "setDailyLimit", 
    ...
    public RemoteCall<Uint256> releasedSupply() {
    ...
    public RemoteCall<Address> pendingOwner() {
    ...
    public RemoteCall<TransactionReceipt> releaseSupply(Uint256 releaseAmount, Uint256 timestamp) {
        Function function = new Function(
                "releaseSupply", 
                Arrays.<Type>asList(releaseAmount, timestamp), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<Uint256> frozenRecordsCount() {
    ...
    public RemoteCall<Tuple2<Uint256, Uint256>> frozenRecords(Uint256 param0) {
    ...
    public static RemoteCall<TtlContract> deploy(Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit, Uint256 initialSupply,
            Uint256 initReleasedSupply, Address operator) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(initialSupply, initReleasedSupply, operator));
        return deployRemoteCall(TtlContract.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<TtlContract> deploy(Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit, Uint256 initialSupply,
            Uint256 initReleasedSupply, Address operator) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(initialSupply, initReleasedSupply, operator));
        return deployRemoteCall(TtlContract.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static TtlContract load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new TtlContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static TtlContract load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new TtlContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
