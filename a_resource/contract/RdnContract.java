 ...
 */
public class RdnContract extends Contract {
    ...
    protected RdnContract(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected RdnContract(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public List<DeployedEventResponse> getDeployedEvents(TransactionReceipt transactionReceipt) {
        final Event event = new Event("Deployed", 
    ...
    public Observable<DeployedEventResponse> deployedEventObservable(DefaultBlockParameter startBlock,
    ...
    public List<BurntEventResponse> getBurntEvents(TransactionReceipt transactionReceipt) {
        final Event event = new Event("Burnt", 
    ...
    public Observable<BurntEventResponse> burntEventObservable(DefaultBlockParameter startBlock,
            DefaultBlockParameter endBlock) {
        final Event event = new Event("Burnt", 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}),
                Arrays.<TypeReference<?>>asList());
    ...
    public static RemoteCall<RdnContract> deploy(Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit, String auction_address, String wallet_address,
            BigInteger initial_supply) {
        ...
        return deployRemoteCall(RdnContract.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<RdnContract> deploy(Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit, String auction_address, String wallet_address,
            BigInteger initial_supply) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(auction_address),
                new Address(wallet_address),
                new Uint256(initial_supply)));
        return deployRemoteCall(RdnContract.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RdnContract load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new RdnContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static RdnContract load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new RdnContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
