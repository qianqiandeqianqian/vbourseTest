...
<head>
    ...
    <jsp:include page="../../view/admin_header.jsp"/>
    <sitemesh:write property='head' />
</head>
<body class="layui-layout-body">
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">玩家网后台</div>
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/admin/loginOut">退出</a></li>
        </ul>
    </div>
    ...
    <div class="layui-body" style="width:100%;height:100px;box-sizing:border-box;">
        <!-- 内容主体区域 -->
